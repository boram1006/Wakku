...
## cards 섹션 — 카드 수에 따른 그리드 열 수 규칙 (반드시 지킬 것)
- 카드 수 = 2 → repeat(2, 1fr)
- 카드 수 = 3 → repeat(3, 1fr)  ← 3개는 반드시 3열. 절대 2열 금지.
- 카드 수 = 4 → repeat(2, 1fr)  ← 4개는 반드시 2열. 3열로 하면 마지막이 혼자 남아 어색.
- 카드 수 = 5 → repeat(3, 1fr)  ← 5개는 3열(2+3 배치)
- 카드 수 = 6 → repeat(3, 1fr)
- 카드 수 ≥ 7 → repeat(3, 1fr)
